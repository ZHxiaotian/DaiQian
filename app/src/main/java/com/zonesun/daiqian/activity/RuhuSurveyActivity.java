...
public class RuhuSurveyActivity extends BaseActivity {

    public FragmentTransaction ft;

    private String name;
    private RuhuSurveyFragment fragment;
    ...
    private void initView() {
        ...
        tv_titleText.setText("贷前管理系统》入户调查");// 改变标题文字-->个人设置
//
        ...
        tv_titleText.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                Util.getCamera(RuhuSurveyActivity.this, "杨林林",
                        "130131199508180920");
            }
        });
        ...
        fragment = new RuhuSurveyFragment();
         //MyApplication.getInstance().fragment = fragment;
    ...
    private SlideMenuFragment fragment2 = new SlideMenuFragment();
