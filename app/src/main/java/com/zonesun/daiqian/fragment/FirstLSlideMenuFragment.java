...
import com.zonesun.daiqian.activity.FirstlendingsurActivity;
...
public class FirstLSlideMenuFragment extends BaseFragment implements View.OnClickListener ,LoadMoreListView.IloadListener {
    ...
    private FirstlendingsurActivity activity;
    ...
    public View initView() {
        view = View.inflate(mActivity, R.layout.fragment_firlendslide, null);
        ...
        activity = (FirstlendingsurActivity) getActivity();
     ...
     * 给listview设置适配
     */
    List<RuHuSurveyEntity.VisitalrearyEntity> listVisitalreary;
    ...
    public void onRefreshwfs() {
        ...
        list = list  = mRealm.where(RuHuData.class).findAll();// 查询本地缓存的数据
        if (list != null && list.size() > 0) {
