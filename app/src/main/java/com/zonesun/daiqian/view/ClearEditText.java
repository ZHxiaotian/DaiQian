...
import com.zonesun.daiqian.entity.User;
		...
		if (event.getAction() == MotionEvent.ACTION_UP) {
			if (getCompoundDrawables()[2] != null) {
				...
				if (touchable) {
					...
					// List<User> mList=dao.seletAll();
					// if (mList != null && mList.size() > 0
					// && !activity.mInitPopup) {
					// activity.mInitPopup = true;
					// activity.initPopup(mList);
					// }
					// if (activity.mPopup != null) {
					// if (!activity.mShowing) {
					// activity.mPopup.showAsDropDown(activity.et_user, 0,
					// -5);
					// activity.mShowing = true;
					// } else {
